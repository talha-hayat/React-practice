        ...
        <div className='min-h-screen flex sm:flex-row md:flex-wrap lg:mx-auto'>
            ...
            <div className='w-[50%] flex items-center justify-center min-h-screen'>
                <form className=' w-[60%] h-[400px]'>
                    ...
                    <Input className='border-2 border-zinc-400 p-3 rounded-xl mt-4' type='text' placeholder='First Name'/>
                    ...
                    <Button className='hover:border-2 hover:border-red-600 hover:bg-white hover:text-red-600 text-lg font-bold rounded-lg p-4 w-[100%] mt-4 text-white bg-red-600'>
                        Create Account
                    </Button>
